...
// [PERBAIKAN] Konstanta disesuaikan dengan data Anda
...
const unsigned long SETTLING_TIME_MS = 2500; // [PERBAIKAN] Waktu lebih responsif
...
void runStabilityGuardian(int current_pill_count) {
    ...
    if (isSystemStable) {
        // [PERBAIKAN] Selalu ambil pembacaan stabil baru saat penjaga aktif
...
void printDiagnostics(int pill_count, float current_filtered_raw) {
    Serial.print("K: "); Serial.print(k_value);
    Serial.print(" | Nilai Terfilter: "); Serial.print(long(current_filtered_raw));
    ...
    Serial.print(" | Prediksi Obat: "); Serial.println(pill_count);
}
...
void setup() {
    Serial.begin(115200);
    Serial.println("Inisialisasi Sistem KNN Robust Final (v2)...");
    scale.begin(13, 14);
...
void loop() {
    ...
    printDiagnostics(current_pill_prediction, filtered_raw);
