...
// --- [KONFIGURASI] ---
#define K_VALUE 11  // K harus ganjil (3, 5, 7, 9, 11)
...
int classifyPillCount(float current_filtered_raw) {
  ...
  // [DIAGNOSTIK] Tampilkan hasil pemungutan suara
...
void setup() {
  Serial.begin(115200);
  Serial.println("Inisialisasi Sistem KNN Fotografer (Informatif)...");
  scale.begin(13, 14);
...
void loop() {
  ...
  runStabilityGuardian();  // Jalankan setelah output utama agar tidak mengganggu
